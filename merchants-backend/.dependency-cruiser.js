...
module.exports = {
  forbidden: [
    /* rules from hexagonal architecture: */
    {
      name: 'domain-accessing-others-layers',
      comment:
        'The domain layer should not access layers outside of the domain layer',
      severity: 'error',
      to: { pathNot: 'domain' },
      from: { path: 'domain' },
    },
    {
      ...
      comment:
        'The application layer should not access the infrastructure layer',
      severity: 'error',
      from: {
        path: 'application',
        pathNot: '\\.module.ts$',
    ...
    {
      name: 'infrastructure-accessing-presenters',
      comment:
        'The infrastructure layer should not access the presenters layer',
      severity: 'error',
      from: { path: 'infrastructure', pathNot: '\\.module.ts$' },
      to: { path: 'presenters' },
    },
...
// generated: dependency-cruiser@16.2.4 on 2024-03-20T22:29:15.083Z
